...
export const authIdentities = pgTable(
  "auth_identities",
  {
    ...
    emailInvocationEnabled: boolean("email_invocation_enabled").notNull().default(false),
    emailDeliveryEnabled: boolean("email_delivery_enabled").notNull().default(false),
