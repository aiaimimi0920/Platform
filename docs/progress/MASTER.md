...
- [ ] Phase 4: 核心领域测试与安全可观测性 (2/4 tasks) [details](./phase-4-domain-security-observability.md)
...
- 当前动作：`P4-02` 已完成并通过 core/account-domain/executor 的 typecheck 与 focused/workspace suites；下一步进入 `P4-03`，补齐 required fixture、OAuth callback/state/account-linking contract，并把 integration fixture 接入 acceptance gate。
...
1. 完成 `P4-03`，补齐 required PostgreSQL / Valkey / S3 fixture 与 OAuth callback/state/account-linking contract。
