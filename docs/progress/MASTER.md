...
- 当前动作：`P4-04` 已完成，已补齐 correlation id、dependency error taxonomy、Operator diagnostics 与 secret redaction；下一步进入 `P5-01`，收口 production-grade Kustomize。
...
1. 进入 `P5-01`，补齐 production-grade Kustomize、migration job、secret contract 与 rollout/smoke gate。
