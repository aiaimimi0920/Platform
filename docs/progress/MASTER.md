...
- [ ] Phase 3: 产品真实性与正式入口 (3/4 tasks) [details](./phase-3-product-truthfulness.md)
...
- 当前动作：`P3-03` 已完成并通过 Web 全量测试与 Next 生产构建校验；下一步进入 `P3-04`，实现真实 managed-heavy slot 控件。
...
1. 完成 `P3-04`，实现真实 managed-heavy slot 控件。
