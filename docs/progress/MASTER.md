...
- [ ] Phase 1: 验收基础设施与真实门禁 (1/4 tasks) [details](./phase-1-acceptance-infrastructure.md)
...
- 当前阶段：Phase 1。
- 已完成：Phase 0 全部设计任务；`P1-01` acceptance manifest、命令执行器、证据脱敏和 required skip-fail runner。
- 当前动作：按依赖图推进 `P1-02` isolated Compose 与 `P1-03` readiness/auth guard。
- 运行时代码：已进入 Phase 1 实施；严格命令清单与 `smoke` bridge 仍由 `P1-04` 完成。

## Next Steps

1. 完成 Phase 1 `P1-02` 和 `P1-03` 的独立 RED/GREEN cycle。
