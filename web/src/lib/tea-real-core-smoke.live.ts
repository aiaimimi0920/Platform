...
export const registerTeaWebRealSmokeTest = () =>
  test(
...
if (process.argv.some((argument) => /tea-real-core-smoke\.live\.ts$/i.test(argument.replaceAll("\\", "/")))) {
