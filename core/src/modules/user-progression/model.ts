...
const progressionLevels: ProgressionLevelDefinition[] = [
  ...
  },
  {
    ...
    title: "活跃用户",
    minExperience: 120,
    rewardDiscountRate: 0.02,
    benefits: [
      {
        key: "obsidian-discount-2",
        kind: "discount",
        title: "曜石商品 2% 自动优惠",
        description: "曜石商品自动参与等级优惠，若同时输入优惠码，系统择优生效。",
      },
      {
  ...
  },
  {
    ...
    title: "协作者",
    minExperience: 320,
    rewardDiscountRate: 0.05,
    benefits: [
      {
        key: "obsidian-discount-5",
        kind: "discount",
        title: "曜石商品 5% 自动优惠",
        description: "高于通用促活层的常驻折扣，继续与优惠码保持择优规则。",
      },
      {
  ...
  },
  {
    ...
    title: "共建者",
    minExperience: 640,
    rewardDiscountRate: 0.08,
    benefits: [
      {
        key: "obsidian-discount-8",
        kind: "discount",
        title: "曜石商品 8% 自动优惠",
        description: "适用于长期参与用户的常驻减免，不会改写商品币种，只降低应付额。",
      },
      {
        key: "advanced-access",
        kind: "access",
  ...
  },
  {
    ...
    title: "核心伙伴",
    minExperience: 1040,
    rewardDiscountRate: 0.1,
    benefits: [
      {
        key: "obsidian-discount-10",
        kind: "discount",
        title: "曜石商品 10% 自动优惠",
        description: "进入核心参与层后，常驻优惠提升到两位数，但仍遵守商品资格与限购规则。",
      },
      {
  ...
  },
  {
    ...
    title: "平台节点",
    minExperience: 1560,
    rewardDiscountRate: 0.12,
    benefits: [
      {
        key: "obsidian-discount-12",
        kind: "discount",
        title: "曜石商品 12% 自动优惠",
        description: "当前等级体系中的最高常驻优惠档位，仍与优惠码保持择优，不做叠加。",
      },
      {
        key: "node-access",
        kind: "access",
